...
function ContactForm({ initialData, mode, id }) {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            if (mode === "create") {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createContact"])(formData);
            } else if (mode === "edit" && id) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateContact"])(id, formData);
            }
            router.push("/");
            router.refresh();
        } catch (err) {
...
"[project]/src/app/contacts/[id]/edit/page.tsx [app-rsc] (ecmascript, Next.js server component, client modules ssr)": ((__turbopack_context__) => {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__0f7efd._.js.map