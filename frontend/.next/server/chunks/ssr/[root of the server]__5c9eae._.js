...
"[project]/src/data/contacts.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$contacts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/data/contacts.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function ContactForm({ initialData, mode, id }) {
    ...
    const handleSubmit = (e)=>{
        ...
        if (mode === "create") {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$contacts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["contacts"].push({
                id: (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$contacts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["contacts"].length + 1).toString(),
                ...formData
            });
        } else if (mode === "edit" && id) {
            const index = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$contacts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["contacts"].findIndex((c)=>c.id === id);
            if (index !== -1) {
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$contacts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["contacts"][index] = {
                    ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$contacts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["contacts"][index],
                    ...formData
                };
            }
...
"[project]/src/app/contacts/new/page.tsx [app-rsc] (ecmascript, Next.js server component, client modules ssr)": ((__turbopack_context__) => {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__5c9eae._.js.map